      ...
      <SafeAreaView style={styles.safeArea} edges={["top", "bottom"]}>
        ...
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <Text style={styles.intro}>
            Welcome to <Text style={{ fontWeight: "600" }}>HomeSense!</Text>{" "}
            Your smart partner for tracking and saving electricity at home.
          ...
          <View style={styles.stepCard}>
            ...
            <View style={styles.stepContent}>
              ...
              <Text style={styles.stepText}>
                ...
                will set it up for you. Once linked, they’ll appear
          ...
          <View style={styles.stepCard}>
            ...
            <View style={styles.stepContent}>
              ...
              <Text style={styles.stepText}>
                ...
                live and historical energy use. Tap any appliance to view
                detailed graphs and cost estimates.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.stepCard}>
            ...
            <View style={styles.stepContent}>
              ...
              <Text style={styles.stepText}>
                Check the <Text style={styles.bold}>Recommendations</Text> tab
                for personalized energy-saving tips based on your habits.
              </Text>
            </View>
          </View>
          ...
          <View style={styles.stepCard}>
            ...
            <View style={styles.stepContent}>
              ...
              <Text style={styles.stepText}>
                View your reduced energy usage and estimated bill savings in
                your <Text style={styles.bold}>Dashboard</Text>, every kWh
                counts!
              </Text>
            </View>
          </View>
          ...
          <View style={styles.footer}>
            <Icon name="check-circle" size={36} color="#FFD700" />
